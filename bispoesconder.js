...
function nextDialogue(){
  ...
  if (textnum<=3){
    ...
    $('#box').html('<div class="data-container"><a href="contra_viu.html" class="button">CONTRA</a></div><div class="data-container"><a  href="favor_viu.html" class="button">A FAVOR</a></div><div class="data-container"><a  href="ouviu.html" class="button">VOLTAR E TENTAR NOVAMENTE</a></div>') ;
  }else{
    textnum = 0;
  }
